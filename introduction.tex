...
\begin{lemma}\label{lem:quadratic_integers}
	...
	\[
		\mathcal{O}_K = \begin{cases}
			...
			\mathbb{Z}\benbrace*{\frac{1+ \sqrt{D}}{2}}, &\text{ if } D \equiv 1 \mod 4
		\end{cases}
	\]
\end{lemma}
\begin{proof}
	...
	Our element $a + b \sqrt{D}$ is contained in the ring $\mathbb{Z}\benbrace[\big]{\frac{1+ \sqrt{D}}{2}}$ as a little calculation shows:
	\[
...
\todo[inline]{Quadratische Zahlkörper erläutern}
\todo[inline]{ring localization}


\section{Affine shemes}
\label{sec:affine shemes}
